...
/*!
 * @brief Module superloop function: Increments the stuff counter once.
 */
void
...
/*!
 * @brief Increment this module's stuff counter by some given amount.
 *
 * @param[in] stuff  The amount of stuff received.
 *
